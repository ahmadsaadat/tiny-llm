...
class Table:
    ...
    @property
    def tables_dict(self) -> dict:
        return {
            "table_embedding": self.table_embedding,
            "table_position": self.table_position,
            "table_lm_head": self.table_lm_head,
            "table_norm1_gamma": self.table_norm1_gamma,
            "table_norm1_beta": self.table_norm1_beta,
            "table_norm2_gamma": self.table_norm2_gamma,
            "table_norm2_beta": self.table_norm2_beta,
            "table_W1": self.table_W1,
            "table_b1": self.table_b1,
            "table_W2": self.table_W2,
            "table_b2": self.table_b2,
            "table_W_Q": self.table_W_Q,
            "table_W_K": self.table_W_K,
            "table_W_V": self.table_W_V,
            "table_W_O": self.table_W_O,
        }
